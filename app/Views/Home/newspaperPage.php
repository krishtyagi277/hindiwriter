        ...
        <div class="row ">
            ...
            <div class="col-8 col-sm-8 col-md-8 col-lg-8 intro-box-container">
                <div class="row mt-2 p-0">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 intro-box-container justify-content-center">
                        <img src="<?=site_url("/img/9.png")?>"
                            class="img-fluid mx-auto d-block section-heading-newpaper wow fadeInDown" data-wow-delay="0.3s"
                            alt="intro-box" />
                        <div class="intro-box-text">
                            <p class="text-center mt-2 wow fadeInUp section-text section-newspaper-text" data-wow-delay="0.3s"><b>
                                    <a href="#"
                                        class="text-white">डॉ. रमेश पोखरियाल 'निशंक' जी  को साहित्य गौरव सामान</a></b>
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mt-2 p-0">
                    <div class="col-sm-12 col-md-12 col-lg-12 intro-box-container justify-content-center">
                        ...
                        <div class="intro-box-text">
                            <p class="text-center mt-2 wow fadeInUp section-text section-newspaper-text" data-wow-delay="0.3s"><b>
                                    <a href="#"
                                        class="text-white">विश्वरंग के समय भारतीय अखबारों में गिल्ड</a></b>
                            </p>
                        </div>
                    </div>
                </div>
