...
<head>
    ...
    <meta name="title" content="हमारी प्रकाशित पुस्तकें">
    <meta name="description" content="हमारी प्रकाशित पुस्तकें">
    <meta property="og:url" content="<?=site_url("/home/ourbooks")?>" />
    <meta property="og:type" content="website">
    <meta property="og:description" content="हमारी प्रकाशित पुस्तकें">
    <meta property="og:title" content="हमारी प्रकाशित पुस्तकें">
        ...
        <div class="row mb-2">
            ...
            <div class="row mt-2 p-0">
                ...
                <div class="d-flex flex-md-row flex-lg-row flex-sm-column justify-content-center align-items-center flex-wrap"
                    ...
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/2.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/2.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/3.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/3.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/4.png"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/4.png"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/5.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/5.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/6.png"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/6.png"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/7.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/7.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/8.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/8.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/9.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/9.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/10.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/10.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/11.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/11.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/12.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/12.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/13.jpg"))?>">
                        <img src="<?=site_url(strtolower("/img/ourbooks/13.jpg"))?>" class="img-fluid h-100"
                            alt="photo-gallery" />
                    </a>
                    <a class="our-books m-1 wow fadeInLeft" href="<?=site_url(strtolower("/img/ourbooks/14.jpg"))?>">
