...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" id="nav-bar">
        <a href="http://sahityakunj.net/" target="_blank"><img src="<?=site_url("/img/sahityakunj/logo250x66.png") ?>" class="img-fluid bg-white" alt="Brand"
                id="brand"></a>
        ...
        <div class="row mb-2">
            ...
            <div class="col-12 col-sm-8 col-md-8 col-lg-8 intro-box-container">
                ...
                <div
                    ...
                    <div class="container">
                        <h2 class="text-dark"> <b>हमारी सेवाएं</b></h2>
