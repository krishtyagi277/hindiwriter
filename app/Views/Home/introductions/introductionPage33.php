        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-10 col-md-10 col-lg-10">
                ...
                <div class="row rounded bg-white pt-3 pb-3 mb-5 w-100 wow fadeInUp mt-4 intro-description-page" data-wow-delay="0.5s">
                    ...
                    <div class="col-sm-8 col-md-8 col-lg-12 pl-3 pr-0 pt-2 wow fadeInRight" data-wow-delay="1.8s">
                        ...
                        <div class="intro-page-description">
                            ...
                            <p>
                                <strong>साहित्य</strong>
                                <strong> </strong>
                                <strong>क्षेत्र</strong>
                                <strong>:</strong>
                                १९९५ में कैनेडा आने के बाद स्थानीय
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                <strong>विधा</strong>
                                <strong>:</strong>
                                कविता, लेख (वेदना, जीवन दर्शन,
                            </p>
                            <p>
                                नैतिकता, प्रकृतिऔर बदलते सामाजिक मूल्य)
                            </p>
                            <p>
                                <strong>उपल्ब्धि</strong>
                                <strong> </strong>
                                <strong>याँ</strong>
                                <strong>:</strong>
                                टोरोंटो के वरिष्ठ नागरिकों (सीनियर सिटिज़न्स) के कार्यक्रमों में अनवरत
                                सक्रिय, उनके कार्यक्रमों में कविगोष्ठियों आदि का आयोजन,
                            </p>
                            <p>
                                स्कारबरो के कैनेडियन सीनियर सिटि ज़न्स क्लब की उप-प्रधान
                            </p>
                        </div>
                        <!--end -->
