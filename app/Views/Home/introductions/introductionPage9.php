                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 pt-2 wow fadeInRight" data-wow-delay="1.8s">
                        ...
                        <div class="intro-page-description">
                            ...
                            <p>
                                ...
                                <strong>:</strong>
                                विज्ञान स्नातक- मेरठ विश्वविद्यालय, तदोपरान्त स्नातक पशु चिकित्सा- गोविंद
                                बल्लभ पन्त विश्वविद्यालय
                            </p>
                            <p>
                                <strong>सम्प्रति</strong>
                                <strong>:</strong>
                                निजी व्यवसाय (किचनर, ओंटेरियो में)
                            </p>
                            <p>
                                <strong>प्रकाशन</strong>
                                <strong>:</strong>
                                गीत सुमीत (कविता संग्रह), Only Better Parents have Best Child.
                            </p>
                            <p>
                                <strong>सम्पर्क</strong>
                                <strong>:</strong>
                                dr.nkgrover@gmail.com
                            </p>
                        </div>
                        <!--end -->
