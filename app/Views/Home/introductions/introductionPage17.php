                ...
                <div class="row rounded bg-white pt-3 pb-3 mb-5 w-100 wow fadeInUp mt-4 intro-description-page" data-wow-delay="0.5s">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12 pl-3 pr-0 pt-2 wow fadeInRight" data-wow-delay="1.8s">
                        ...
                        <div class="intro-page-description">
                            ...
                            <p>
                                एम.डी. आगरा विश्वविद्यालय से; एफ़.आर.सी.पी.
                            </p>
                            <p>
                                (सी) कैनेडा से।
                            </p>
                            <p>
                                ...
                                <strong>:</strong>
                                मैडिकल विशेषज्ञ रहने के बाद सेवा
                            </p>
                            <p>
                                निवृत्त
                            </p>
                            <p>
                                ...
                                <strong>विधा</strong>
                                <strong>:</strong>
                                मूलतः गीतकार। हाईस्कूल से लिखना
                            </p>
                            <p>
                                आरम्भ हुआ और आजीवन चला।
                            </p>
                            <p>
                                प्रकाशन: स्कूल काल से ही विभिन्न पत्रिकाओं में
                            </p>
                            <p>
                                प्रकाशन। तीन काव्य संग्रह– चन्दन वन, प्रि यम्वदा
                            </p>
                            <p>
                                और इन्दीवर प्रकाशित।
                            </p>
                            <p>
                                <strong>विशेष</strong>
                                <strong>:</strong>
                                टोरोंटो (कैनेडा) में हिन्दी भाषा के प्रचार-
                            </p>
                            <p>
                                प्रसार एवं विकास से सम्बद्ध रहे।
                            </p>
                        </div>
                        <!--end -->
